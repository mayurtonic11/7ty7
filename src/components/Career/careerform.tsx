...
const CareerForm = () => {
  ...
  return (
    <div>
          ...
          {({ errors, touched, isSubmitting }) => (
            <Form>
              <div className="row">
                ...
                <div className="col-md-6 form-group">
                  <label className="form-label" htmlFor="applyFor">
                    Apply For
                  </label>
                  <Field
                    as="select"
                  ...
                  >
                    ...
                    <option value="position1" label="Position 1" />
                    <option value="position2" label="Position 2" />
                  </Field>
                </div>
                <div className="col-12 form-group">
                  <div>
      ...
      {showPopup && (
        <div className="modal-overlay career-popup" onClick={closeModal}>
